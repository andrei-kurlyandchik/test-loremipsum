module.exports = {
  ...
  favicon: {
    src: `./src/img/favicons/*.{jpg,jpeg,png,gif,ico}`,
  ...
  images: {
    src: [`./src/img/**/*.{jpg,jpeg,png,gif,svg,mp4,ico,gif}`, `!./src/img/svg/icons/*`, `!./src/img/favicons/*.{jpg,jpeg,png,gif,svg,ico}`],
    dest: `./dist/img/`,
    watch: `src/img/**/*`
  },
  style: {
  ...
  // webp: {
  //   src: [`./src/img/**/*.{jpg,jpeg,png,gif}`, `!./src/img/svg/icons/*`, `!./src/img/favicons/*.{jpg,jpeg,png,gif,svg,ico}`],
  //   dest: `./dist/img/`
  // },
  deploy: {
    dest: `../www/`,
